...
SELECT DISTINCT m.name, m.brand_name, b.founded
...
An inner join will give you a set of values shared by two tables, 
whereas a left join will give you a set of all the values in the
first table, regardless of whether or not they have a matching
entry in the second table for the shared key.
...
VALUES ('IIHS Safety Award','2015', (SELECT id FROM Models
WHERE name = 'Chevrolet' AND brand_name = 'Malibu' AND year = '2015'))

INSERT INTO Awards (name, year, winner)
VALUES ('IIHS Safety Award','2015', (SELECT id FROM Models
WHERE name = 'Subaru' AND brand_name = 'Outback' AND year = '2015'))
